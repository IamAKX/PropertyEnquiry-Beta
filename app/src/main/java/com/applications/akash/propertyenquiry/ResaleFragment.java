...
public class ResaleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.resale_fragment,container,false);
        return myView;
    }
    ...
    public void getPropertyData()
    {
        ...
        String param = "";
        HttpConnection http = new HttpConnection("http://anamexamplecafe.esy.es/propertyenquiry/getresaledata.php");
