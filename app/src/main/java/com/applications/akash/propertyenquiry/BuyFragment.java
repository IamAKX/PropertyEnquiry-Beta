...
public class BuyFragment extends Fragment {
    ...
    private static ArrayList<PropertyCard> datas;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.buy_fragment,container,false);
        return myView;
    }
    ...
    public void getPropertyData()
    {
        ...
        String param = "";
        HttpConnection http = new HttpConnection("http://anamexamplecafe.esy.es/propertyenquiry/getbuydata.php");
        try {
